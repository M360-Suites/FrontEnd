...
const FirstTimeSchedule = () => {
  ...
  useEffect(() => {
    // Create a lighter animation timeline with fewer animations
  ...
  return (
    <div className="p-4 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-around items-center border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
        <div className="flex flex-col gap-5 w-full md:w-1/2 mb-6 md:mb-0" ref={headerRef}>
          <div>
      ...
      <div className="flex flex-col md:flex-row justify-center mt-10 gap-4 md:gap-8">
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <p className="font-medium text-sm md:text-base">Connect Your Socials</p>
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <p className="font-medium text-sm md:text-base">Create First Post</p>
