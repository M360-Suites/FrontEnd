...
const CampaignReports = ({ campaigns = [] }) => {
		...
		<div className='mt-4 sm:mt-6'>
			<div className='flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-16'>
				...
				<div className='w-full lg:w-[800px] border border-gray-200 p-3 sm:p-4 md:p-6 rounded-lg shadow-sm bg-white'>
					<div className='flex justify-between items-start mb-4 sm:mb-6'>
						<div className='flex flex-col gap-0.5 sm:gap-1'>
							<div className='flex items-center gap-1.5 sm:gap-2'>
								<Icon
									className='text-xl sm:text-2xl text-primary-orange'
					...
					{/* Table Body */}
					<div className='space-y-1 mt-2 max-h-[400px] overflow-y-auto custom-scrollbar'>
						{campaigns.length > 0 ? (
								...
								>
									...
									<div className='md:hidden p-3 hover:bg-gray-50 active:bg-gray-100'>
										<div className='flex justify-between items-start mb-2'>
											<h3 className='font-medium text-sm line-clamp-1 pr-2 flex-1'>
												{report.name}
											</h3>
											<span
										...
										<div className='flex justify-between items-center mt-3 text-xs'>
											<div className='flex flex-col items-center'>
												...
												<span className='font-semibold'>
													{report.stats?.sent?.toLocaleString() || 0}
												</span>
											</div>
											...
											<div className='flex flex-col items-center'>
												...
												<span className='font-semibold'>
													{report.stats?.delivered?.toLocaleString() ||
														0}
												</span>
											</div>
									...
									<div className='hidden md:grid md:grid-cols-5 md:gap-4 md:py-4 md:px-4 md:hover:bg-gray-50'>
										...
										<div className='hidden md:flex justify-center items-center'>
											{report.stats?.delivered?.toLocaleString() || 0}
										</div>
										<div className='hidden md:flex justify-center items-center'>
											{report.stats?.openRate || 0}%
										</div>
					...
					<div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-3 sm:gap-4'>
						...
						<div className='bg-gray-50 p-3 sm:p-4 rounded-lg'>
							...
							<div className='w-full bg-gray-200 rounded-full h-1.5 sm:h-2 mt-1.5 sm:mt-2'>
								<div
									className='bg-primary-orange h-1.5 sm:h-2 rounded-full'
									style={{ width: "67%" }}
								></div>
							</div>
						</div>
