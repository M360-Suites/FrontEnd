    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
      ...
      >
        <div className='w-[100px] h-[100px] md:w-[175px] md:h-[175px] mx-auto'>
          <img className='w-full h-full object-contain' src={Pop} alt="Success" />
        </div>
        ...
        <div className='mt-6 md:mt-10 text-center'>
          ...
          <Button
            title={"Login"}
            className={"bg-primary-orange text-white py-3 md:py-4 px-4 md:px-8 rounded-lg w-full md:w-[250px] lg:w-[300px] text-base md:text-lg font-medium hover:bg-light-orange transition-colors duration-300"}
          />
        </div>
      </div>
    </div>
